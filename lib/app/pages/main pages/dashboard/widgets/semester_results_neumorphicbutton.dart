...
class SemesterResults_NeumorphicButton extends StatefulWidget {
  ...
  @override
  State<SemesterResults_NeumorphicButton> createState() =>
      _SemesterResults_NeumorphicButtonState();
}

class _SemesterResults_NeumorphicButtonState
    extends State<SemesterResults_NeumorphicButton> {
  bool _isPressed = false;

  void _onPointerDown(TapDownDetailsvent) {
    widget.onPressed;
    setState(() {
      _isPressed = true;
    });
