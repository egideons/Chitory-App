...
class SendCodeNeumorphicButton extends StatefulWidget {
  ...
  @override
  State<SendCodeNeumorphicButton> createState() =>
      _SendCodeNeumorphicButtonState();
}

class _SendCodeNeumorphicButtonState extends State<SendCodeNeumorphicButton> {
